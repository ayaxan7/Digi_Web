...
const HistoryPage: React.FC = () => {
  ...
  const fetchHistory = async () => {
    ...
    try {
        ...
        // Handle missing table error gracefully (Postgres code 42P01) or Schema error (PGRST106)
        if (err?.code === '42P01' || err?.code === 'PGRST106') {
           console.warn("Chat history table missing or inaccessible. History feature disabled.");
           setHistory([]);
        } else {
